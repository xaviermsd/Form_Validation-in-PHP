...
$fname=$lname=$company=$email=$phone=$subject=$developer=$success=$error="";
$nameErr = $emailErr = "";
                                ...
                                <div class="input-group">
                                    <div class="rs-select2 js-select-simple select--no-search">
                                        <select name="subject">
                                            ...
                                            <option selected="selected"value="sub1">Subject 1</option>
                                            <option value="sub2">Subject 2</option>
                                            <option valiue="sub3">Subject 3</option>
                                        </select>
